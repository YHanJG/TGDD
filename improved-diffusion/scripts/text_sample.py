...
def main():
    logging.basicConfig(filename='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/improved-diffusion/log/text_sample_log.log', level=logging.INFO)
    ...
    print('--'*30)
    logging.info(args.num_samples)
    logging.info('--'*30)
    logging.info('loading {} set'.format(args.split))
    logging.info('--'*30)
    ...
    logging.info(len(train_dataset),(train_dataset[0]['desc_state'].shape))
    ...
    while num_done < args.num_samples:
        ...
        logging.info('acquiring  {} : {}'.format(num_done,idend))
        ...
        logging.info('use_ddim:{}',args.use_ddim)
        
        num_done = idend
    sample = th.concat(allsample,dim=0)
    print('decoding for e2e', )
    logging.info('decoding for e2e', )
    print(sample.shape)
    ...
    f = open('/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/tempbadmols.txt','w')
...
def create_argparser():
    ...
    text_defaults = dict(modality='text',
                        ...
                        #  model_path='../../checkpoints/PLAIN_ema_0.9999_200000.pt',
                         model_path='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/checkpoints/PLAIN_ema_0.9999_070000.pt',
                         use_ddim=False,
                         batch_size =64,num_samples=3300,top_p =1.0,out_dir='generation_outputs',
                        # outputdir='../../textguidtry_256_final.txt'
                         outputdir='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/textguidtry_256_final.txt'
                         )
