...
def create_argparser():
    ...
    text_defaults = dict(
        ...
        batch_size=64, 
        cache_mode='no', 
        checkpoint_path='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/Doubled/smile_base_6_co_new',
...
if __name__ == "__main__":
    logging.basicConfig(filename='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/improved-diffusion/log/double6co_new.log', level=logging.INFO)
