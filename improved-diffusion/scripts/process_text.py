...
train_dataset = ChEBIdataset(
        ...
        self_tokenizer=smtokenizer,
        split=split,
        replace_desc=False,
        load_state=False
        # pre = pre
    )
model = AutoModel.from_pretrained('/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/scibert')
tokz = AutoTokenizer.from_pretrained('/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/scibert')
...
torch.save(volume,'/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/datasets/Join/'+split+'_desc_states.pt')
print("Encode over")