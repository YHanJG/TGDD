...
from improved_diffusion.transformer_model2 import TransformerNetModel2,TransformerNetModel_two_way
...
def main_worker(rank,world_size):
    ...
    if args.is_join:
        dir='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/datasets/SELFIES'
    if args.is_two_way:
        dir='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/datasets/Join'
...
def create_argparser():
    ...
    text_defaults = dict(
        ...
        batch_size=64, 
        cache_mode='no', 
        checkpoint_path='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/Doubled/smile_base_12_co_new',
...
if __name__ == "__main__":
    logging.basicConfig(filename='/mntcephfs/lab_data/wangcm/jhy/tgm-dlm-main/tgm-dlm-main/improved-diffusion/log/double12co_new.log', level=logging.INFO)
